...
public class UserEntry {
	...
	public void fromJSONObject(JSONObject obj) {
		...
		mProfilePhoto = BaseEncoding.base64Url().decode(
				(String) obj.optString(Globals.KEY_USER_PROFILE_PHOTO));
	...
	public JSONObject toJSONObject() {
		...
		try {
			...
			String encodedImage = BaseEncoding.base64Url()
					.encode(mProfilePhoto);
